<?php 
	...
	$query_str = mssql_query(" select top 100 'Flat' as DB,RowOrder,CardNO,IsOpenCard,IsUpdateCASAlready from Flat.dbo.CustomerCardLog where IsUpdateCASAlready = 0 order by RowOrder asc ");
