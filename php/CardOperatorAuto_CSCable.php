<?php 
	...
	$query_str = mssql_query(" select top 5 'CSCable' as DB,UserID,RowOrder,CardNO,IsOpenCard,IsUpdateCASAlready from CSCable.dbo.CustomerCardLog where IsUpdateCASAlready = 0 order by RowOrder asc ");
