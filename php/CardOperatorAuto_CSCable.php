<?php 
	...
	$query_str = mssql_query(" select top 50 'CSCable' as DB,RowOrder,CardNO,IsOpenCard,IsUpdateCASAlready from CSCable.dbo.CustomerCardLog where IsUpdateCASAlready = 0 order by RowOrder asc ");
