<?php 
	...
	$query_str = mssql_query(" select top 20 'Sakorp' as DB,UserID,RowOrder,CardNO,IsOpenCard,IsUpdateCASAlready from Sakorp.dbo.CustomerCardLog where IsUpdateCASAlready = 0 order by RowOrder asc ");
