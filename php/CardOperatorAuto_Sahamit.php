<?php 
	...
	$query_str = mssql_query(" select top 10 'Sahamit' as DB,UserID,RowOrder,CardNO,IsOpenCard,IsUpdateCASAlready from Sahamit.dbo.CustomerCardLog where IsUpdateCASAlready = 0 order by RowOrder asc ");
