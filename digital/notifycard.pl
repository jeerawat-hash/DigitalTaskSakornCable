  ...
  print " accreditType=CARDOSD&duration=60&id=&message=$name&operate=insert&remark=test&scCode=9980003200006591&sendCount=1&sendInterval=60&sendTime=2019-11-19%2017:10:00&subAreaId=&subTypeId=&title= ";
